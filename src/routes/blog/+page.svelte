    ...
    <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-32">
      ...
      <div class="mt-6 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0">
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Vision of Zero</p>
        </div>
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Selection of technology stack</p>
        </div>
        ...
        <div class="group relative">
          ...
          <p class="text-base font-semibold text-gray-900">Challenges</p>
        </div>
      </div>
    </div>
  </div>
